...
<p>Hub Company built the Hub app as a free app. This SERVICE is provided by I-Vestment and is intended
    for use as is.</p>
...
<p>[I|We] want to inform you that whenever you use our Service, in case of an error in the app [I|we] collect
