    ...
    <div class="box">
        ...
        <div class="box-body">
            <a class="btn btn-success btn-flat @if(app()->getLocale() == 'en') pull-right @else pull-left @endif"
               href="{{ url(adminPath().'/forms/create') }}">{{ trans('admin.add') }}</a>
            <table class="table table-hover table-striped datatable">
                ...
                <tr>
                    ...
                    <th>{{ trans('admin.lead_source') }}</th>
                    <th>{{ trans('admin.form') }}</th>
                ...
                @foreach($forms as $form)
                    <tr>
                        ...
                        <td>
                            {{ $form->{app()->getLocale().'_title'} }}
                        </td>
                        <td>
                            {{ __('admin.'.$form->type) }}
                        </td>
                        <td>
                           {{ @$form->lead_source->name }}
                        </td>
                        <td><a href="{{ url('form/' . slug($form->{app()->getLocale().'_title'}) . '-' . $form->id) }}"
                               class="btn btn-success btn-flat" target="_blank">{{ trans('admin.form') }}</a></td>
                        <td><a href="{{ url(adminPath().'/forms/'.$form->id) }}"
                               class="btn btn-primary btn-flat">{{ trans('admin.show') }}</a></td>
                        <td><a href="{{ url(adminPath().'/forms/'.$form->id.'/edit') }}"
                               class="btn btn-warning btn-flat">{{ trans('admin.edit') }}</a></td>
                        <td><a data-toggle="modal" data-target="#delete{{ $form->id }}"
                               class="btn btn-danger btn-flat">{{ trans('admin.delete') }}</a></td>
                    </tr>
                    <div id="delete{{ $form->id }}" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p>{{ trans('admin.delete') . ' ' . $form->name }}</p>
                                </div>
