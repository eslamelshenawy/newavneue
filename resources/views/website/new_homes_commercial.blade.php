        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h1 class="text-uppercase">{{ __('admin.new_commercial') }}
                    </h1>
                </div>
            </div>
        </div>
                        ...
                        @foreach($projects as $property)
                            <div class="col-sm-6 not-filter">
                                <div class="property_item heading_space">
                                    <div class="image">
                                        <a href="{{ url('project/'.slug($property->{app()->getLocale().'_name'}).'-'.$property->id) }}"><img src="{{ url('uploads/'.$property->cover) }}" alt="{{ $property->{app()->getLocale().'_name'} }}" class="img-responsive"></a>
                                        ...
                                        <span class="tag_t">{{ __('admin.new_commercial') }}</span>
                                    </div>
                ...
                <aside class="col-md-4 col-xs-12 ">
                    <div class="property-query-area clearfix">
                        <form class="callus" action="{{ url('search') }}" method="post" style="padding: 20px">
                            {{ csrf_field() }}
                            <h2 class="text-uppercase t_white bottom20 text-center">{{ trans('admin.filter') }}</h2>
                            <div class="row">
                                <div class="col-sm-12">
                            ...
                            <div class="row">
                                <input type="hidden" name="min_price" id="min_price" value="{{ $search['data']['project_commercial_min_price'] }}">
                                <input type="hidden" name="max_price" id="max_price" value="{{ $search['data']['project_commercial_max_price'] }}">
                                <input type="hidden" name="min_area" id="min_area" value="{{ $search['data']['project_commercial_min_area'] }}">
                                <input type="hidden" name="max_area" id="max_area" value="{{ $search['data']['project_commercial_max_area'] }}">
                                <div class="col-md-12 col-sm-12 col-xs-12 bottom15">
                                    <div class="single-query-slider">
                                        ...
                                        <div id="price_range" data-range_min="{{ $search['data']['project_commercial_min_price'] }}"
                                             data-range_max="{{ $search['data']['project_commercial_max_price'] }}"
                                             data-cur_min="{{ $search['data']['project_commercial_min_price'] }}"
                                             data-cur_max="{{ $search['data']['project_commercial_max_price'] }}"
                                             class="nstSlider">
                                            <div class="bar"></div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 bottom15">
                                    <div class="single-query-slider">
                                        ...
                                        <div id="area_range" data-range_min="{{ $search['data']['project_commercial_min_area'] }}"
                                             data-range_max="{{ $search['data']['project_commercial_max_area'] }}"
                                             data-cur_min="{{ $search['data']['project_commercial_min_area'] }}"
                                             data-cur_max="{{ $search['data']['project_commercial_max_area'] }}"
                                             class="nstSlider">
                                            <div class="bar"></div>
                                            <div class="leftGrip"></div>
                                            <div class="rightGrip"></div>
    ...
    @if(!auth()->guard("lead")->guest())
        ...
        <script>
            ...
            $(document).ready(function () {
                $('#price_range').nstSlider('set_range', parseInt("{{ $search['data']['project_commercial_min_price'] }}"), parseInt("{{ $search['data']['project_commercial_max_price'] }}"));
                $('#area_range').nstSlider('set_range', parseInt("{{ $search['data']['project_commercial_min_area'] }}"), parseInt("{{ $search['data']['project_commercial_max_area'] }}"));
                $('#price_range').nstSlider('set_position', parseInt("{{ $search['data']['project_commercial_min_price'] }}"), parseInt("{{ $search['data']['project_commercial_max_price'] }}"));
                $('#area_range').nstSlider('set_position', parseInt("{{ $search['data']['project_commercial_min_area'] }}"), parseInt("{{ $search['data']['project_commercial_max_area'] }}"));
