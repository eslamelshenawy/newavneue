...
@section('content')
    ...
    <style>
        .page-banner{
            background: url("{{ asset('website_style/images/5.jpg') }}") no-repeat fixed !important;
        }
    </style>
                ...
                <aside class="col-md-4 col-xs-12 ">
                    <div class="property-query-area clearfix">
                        <form class="callus" action="{{ url('search') }}" method="post" style="padding: 20px">
                            ...
                            <div class="row">
                                <input type="hidden" name="min_price" id="min_price" value="{{ $search['data']['resale_personal_min_price'] }}">
                                <input type="hidden" name="max_price" id="max_price" value="{{ $search['data']['resale_personal_max_price'] }}">
                                <input type="hidden" name="min_area" id="min_area" value="{{ $search['data']['resale_personal_min_area'] }}">
                                <input type="hidden" name="max_area" id="max_area" value="{{ $search['data']['resale_personal_max_area'] }}">
                                <div class="col-md-12 col-sm-12 col-xs-12 bottom15">
                                    <div class="single-query-slider">
                                        ...
                                        <div id="price_range" data-range_min="{{ $search['data']['resale_personal_min_price'] }}"
                                             data-range_max="{{ $search['data']['resale_personal_max_price'] }}"
                                             data-cur_min="{{ $search['data']['resale_personal_min_price'] }}"
                                             data-cur_max="{{ $search['data']['resale_personal_max_price'] }}"
                                             class="nstSlider">
                                            <div class="bar"></div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 bottom15">
                                    <div class="single-query-slider">
                                        ...
                                        <div id="area_range" data-range_min="{{ $search['data']['resale_personal_min_area'] }}"
                                             data-range_max="{{ $search['data']['resale_personal_max_area'] }}"
                                             data-cur_min="{{ $search['data']['resale_personal_min_area'] }}"
                                             data-cur_max="{{ $search['data']['resale_personal_max_area'] }}"
                                             class="nstSlider">
                                            <div class="bar"></div>
                                            <div class="leftGrip"></div>
                                            <div class="rightGrip"></div>
